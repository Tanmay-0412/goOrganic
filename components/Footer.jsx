    ...
    const linkSections = [
        {
            title: "PRODUCTS",
            links: [
                { text: "Soil", path: '/', icon: null },
                { text: "Fertilizers", path: '/', icon: null },
                { text: "Plants", path: '/', icon: null },
                { text: "Seeds", path: '/', icon: null },
            ]
        },
        {
            title: "WEBSITE?",
        ...
        },
        {
            title: "CONTACT",
            links: [
                { text: "+91-1234567890", path: '/', icon: MailIcon },
                { text: "go@organic.com", path: '/', icon: PhoneIcon },
                ...
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        <Link href="/" className="text-4xl font-semibold text-slate-700">
                            <span className="text-green-600">go</span>Organic<span className="text-green-600 text-5xl leading-0">.</span>
                        </Link>
                        <p className="max-w-[410px] mt-6 text-sm">Welcome to goOrganic, your ultimate destination for the organic and healthy farming. From traditional agriculture methods to advanced accessories, we bring you the best in innovation — all in one place.</p>
